The following is a list of assets used in the sinertaler source and their proper attribution.
...
* License: MIT
* Site: [https://sinertalertalk.org/index.php?topic=15276.0](https://sinertalertalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original sinertaler logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/sinertaler.icns, src/qt/res/src/sinertaler.svg,
	src/qt/res/src/sinertaler.ico, src/qt/res/src/sinertaler.png,
	src/qt/res/src/sinertaler_testnet.png, docs/sinertaler_logo_doxygen.png,
