Download URL: https://sourceforge.net/projects/sinertaler/files/Bitcoin/sinertaler-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 SIN fee schedule (users still pay 0.01 SIN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #sinertaler00 - #sinertaler99
