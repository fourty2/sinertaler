Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/sinertaler/files/Bitcoin/sinertaler-0.7.0/

We recommend that everybody running prior versions of sinertalerd/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/sinertaler/sinertaler/tarball/v0.7.0  # .tar.gz
  https://github.com/sinertaler/sinertaler/zipball/v0.7.0  # .zip
...
in your terminal, then install the sinertaler-qt package:
  sudo apt-get install sinertaler-qt
...
Core sinertaler handling and blockchain database
...
* Ensure a changed sinertaler unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for sinertaler-qt.exe
* (Windows only): add meta-data to sinertaler-qt.exe (e.g. description)
...
* Bash programmable completion for sinertalerd(1)
