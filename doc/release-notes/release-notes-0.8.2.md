Bitcoin-Qt version 0.8.2 is now available from:
  http://sourceforge.net/projects/sinertaler/files/Bitcoin/sinertaler-0.8.2/
...
The default fee for low-priority transactions is lowered from 0.0005 SIN 
(for each 1,000 bytes in the transaction; an average transaction is
about 500 bytes) to 0.0001 SIN.

Payments (transaction outputs) of 0.543 times the minimum relay fee
(0.00005430 SIN) are now considered 'non-standard', because storing them
...
MacOSX:
* OSX support for click-to-pay (sinertaler:) links
