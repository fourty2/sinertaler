...
SINERTALERD=${1}/sinertalerd
CLI=${1}/sinertaler-cli
...
B4ARGS="-datadir=$D4"
$SINERTALERD $SINERTALERDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$SINERTALERD $SINERTALERDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $SINERTALERD $SINERTALERDARGS $B1ARGS &
  B1PID=$!
  $SINERTALERD $SINERTALERDARGS $B2ARGS &
  B2PID=$!
  $SINERTALERD $SINERTALERDARGS $B3ARGS &
  B3PID=$!
}
