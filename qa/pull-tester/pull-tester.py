...
environ_default("CLONE_URL", "https://github.com/sinertaler/sinertaler.git")
...
environ_default("BUILD_PATH", "/mnt/sinertaler")
...
environ_default("GITHUB_REPO", "sinertaler/sinertaler")
