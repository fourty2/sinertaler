...
allowing somebody to distribute a Bitcoin-Qt.app or sinertaler-qt-setup.exe with a valid
...
that the sinertaler-qt.exe file inside the installer had not been tampered with.
