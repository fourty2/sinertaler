...
This means one can have an always-on sinertalerd instance running, and another local sinertalerd/sinertaler-qt instance which connects to this node and receives blocks from it.
