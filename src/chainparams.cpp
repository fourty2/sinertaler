...
unsigned int pnSeed[] =
{
    ...
    0xc15ebb6a, 0x2c08c452, 0xc7fd0652, 0x7604f8ce, 0xffb339876, 0xa4c2efd5, 0xe9614018, 0xab49e557,
...
public:
    CMainParams() {
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = " 06/Maerz/2014 - der Tag an dem der Siner kam";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1394098061;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 0; //2083236893;
...
while (hashGenesisBlock > bnProofOfWorkLimit.getuint256()){
   ...
   hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.push_back(CDNSSeedData("sinertaler.lobsterlove.de", "seed.sinertaler.sipa.be"));
        //vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        //vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.sinertaler.dashjr.org"));
        //vSeeds.push_back(CDNSSeedData("sinertalerstats.com", "seed.sinertalerstats.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("sinertaler.petertodd.org", "testnet-seed.sinertaler.petertodd.org"));
