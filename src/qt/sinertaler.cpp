...
{
    return QCoreApplication::translate("sinertaler-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. sinertaler_de.qm (shortcut "de" needs to be defined in sinertaler.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. sinertaler_de_DE.qm (shortcut "de_DE" needs to be defined in sinertaler.qrc)
...
void BitcoinApplication::initializeResult(int retval)
{
    ...
    if(retval)
    {
        ...
        // sinertaler: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationDomain("sinertaler.org");
    ...
    /// 6. Determine availability of data directory and parse sinertaler.conf
    ...
    // sinertaler: links repeatedly have their payment requests routed to this process:
